...
const About = () => {
  const paragraphs = [
    ...
    `🎹 Músico profesional: He acompañado a artistas como Wilfrid Energía Humana, Sienna y Sandra Polop, realizando giras por todo el territorio nacional. También he actuado junto a reconocidos intérpretes del panorama musical español como Javier Gurruchaga, Aurora García, Micky y Carlos Tarque, aportando mi experiencia y versatilidad sobre el escenario. He formado parte de destacadas orquestas como La Tribu.
Actualmente, soy músico autónomo, y formo parte de varias formaciones activas como Babalu Swing Band, Da Capo Music y Fitipaldis Band, combinando actuaciones en directo con clases online personalizadas y grabaciones.`,
