...
const About = () => {
  const paragraphs = [
    `¡Hola! Soy un músico con un perfil poco convencional: combino más de 20 años de experiencia en el mundo de la música con una gran afición por la tecnología y la programación. Esta fusión me permite explorar y desarrollar soluciones únicas tanto en el ámbito artístico como en el digital.`,
    ...
    `🎹 Músico profesional: He acompañado a artistas como Wilfrid Energía Humana, Sienna y Sandra Polop, realizando giras por todo el territorio nacional. También he actuado junto a reconocidos intérpretes del panorama musical español como Javier Gurruchaga, Aurora García y Micky, aportando mi experiencia y versatilidad sobre el escenario. He formado parte de destacadas orquestas como La Tribu, con la que he vivido algunas de las experiencias musicales más intensas y enriquecedoras de mi carrera.
Actualmente, soy músico autónomo, y formo parte de varias formaciones activas como Babalu Band, Da Capo Music y Fitipaldis Band, combinando actuaciones en directo con clases online personalizadas y grabaciones.`,
    `🎧 Músico de sesión: Colaboro habitualmente con el estudio *Hive DE* en Valencia y realizo grabaciones desde mi propio home studio, adaptándome a las necesidades de cada proyecto con profesionalidad y creatividad.`,
