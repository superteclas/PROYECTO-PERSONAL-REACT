...
const About = () => {
  const paragraphs = [
    ...
    `🎹 Músico profesional: He acompañado a artistas como Wilfrid Energía Humana, Lex García, Sienna y Sandra Polop, realizando giras por todo el territorio nacional. También he actuado junto a reconocidos intérpretes del panorama musical español como Paco Muñoz, Javier Gurruchaga, Aurora García, Micky, Pau Monteagudo y Carlos Tarque, aportando mi experiencia y versatilidad sobre el escenario. He formado parte de destacadas orquestas como La Tribu.
