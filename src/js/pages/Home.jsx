          ...
          <div className="container">
            <div className="row align-items-center bg-white shadow rounded p-4 p-md-5 mt-5">
              ...
              <div className="col-md-8">
                ...
                <p>
                  Si estás buscando un <strong>pianista en Valencia</strong> para eventos, bodas, producciones musicales o sesiones de grabación, puedo adaptar cada interpretación a tus necesidades. También imparto <strong>clases de piano</strong> para todos los niveles, combinando teoría, armonía moderna e improvisación. Realizo grabaciones desde casa con calidad profesional, ideales para maquetas, cine, publicidad o redes sociales. Vivo en <strong>Valencia</strong> y estoy disponible tanto de forma presencial como online.
                </p>
                <p>
